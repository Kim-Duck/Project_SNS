							...
							<div class="main-ws-sec">
									...
									<div class="tab-feed st2 settingjb">
										<ul>
											<li data-tab="feed-dd" class="active"><a href="#"
												title=""> <img src="resources/images/ic1.png" alt="">
													<span>Feed</span>
											</a></li>
											<li data-tab="info-dd"><a href="#" title=""> <img
													src="resources/images/ic2.png" alt=""> <span>Info</span>
											</a></li>
											<li data-tab="saved-jobs"><a href="#" title=""> <img
													src="resources/images/ic4.png" alt=""> <span>Jobs</span>
											</a></li>
											<li data-tab="my-bids"><a href="#" title=""> <img
													src="resources/images/ic5.png" alt=""> <span>Bids</span>
											</a></li>
											<li data-tab="portfolio-dd"><a href="#" title=""> <img
													src="resources/images/ic3.png" alt=""> <span>Portfolio</span>
											</a></li>
											<li data-tab="rewivewdata"><a href="#" title=""> <img
													src="resources/images/review.png" alt=""> <span>Reviews</span>
											</a></li>
											<li data-tab="payment-dd"><a href="#" title=""> <img
													src="resources/images/ic6.png" alt=""> <span>Payment</span>
											</a></li>
								...
								<div class="product-feed-tab" id="saved-jobs">
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										...
										<li class="nav-item"><a class="nav-link" id="contact-tab"
											data-toggle="tab" href="#applied" role="tab"
											aria-controls="applied" aria-selected="false">Applied
												Jobs</a></li>
										<li class="nav-item"><a class="nav-link"
											id="cadidates-tab" data-toggle="tab" href="#cadidates"
											...
											<div class="posts-bar">
												<div class="post-bar bgclr">
													<div class="wordpressdevlp">
														...
														<p>
															<i class="la la-clock-o"></i>Posted on 30 August 2018
														</p>
													</div>
													<br>
													<div class="row no-gutters">
														<div class="col-md-6 col-sm-12">
															<div class="cadidatesbtn">
																...
																</a> <a href="#"> <i class="far fa-trash-alt"></i>
																</a>
															</div>
														</div>
														<div class="col-md-6 col-sm-12">
											...
											<div class="posts-bar">
												<div class="post-bar bgclr">
													<div class="wordpressdevlp">
														...
														<p>
															<i class="la la-clock-o"></i> Posted on 29 August 2018
														</p>
													</div>
													<br>
													<div class="row no-gutters">
												...
												<div class="post-bar bgclr">
													<div class="wordpressdevlp">
														...
														<div class="row no-gutters">
															<div class="col-md-6 col-sm-12">
																<p class="posttext">
																	<i class="la la-clock-o"></i>Posted on 5 June 2018
																</p>
															</div>
															<div class="col-md-6 col-sm-12">
																<p>
																	<i class="la la-clock-o"></i>Expiried on 5 October 2018
																</p>
															</div>
														</div>
													</div>
											...
											<div class="post-bar">
												...
												<ul class="savedjob-info saved-info">
													...
													<div class="devepbtn saved-btn">
														<a class="clrbtn" href="#">Unsaved</a> <a class="clrbtn"
															href="#">Message</a>
													</div>
												</ul>
											</div>
										...
										<div class="tab-pane fade" id="applied" role="tabpanel"
											...
											<div class="post-bar">
												...
												<ul class="savedjob-info saved-info">
													...
													<div class="devepbtn saved-btn">
														<a class="clrbtn" href="#">Applied</a> <a class="clrbtn"
															href="#">Message</a> <a href="#"> <i
												...
												<div class="post_topbar applied-post">
													...
													<div class="job_descp noborder">
														...
														<div class="devepbtn appliedinfo noreply">
															<a class="clrbtn" href="#">Accept</a> <a class="clrbtn"
																href="#">View Profile</a> <a class="clrbtn" href="#">Message</a>
															<a href="#"> <i class="far fa-trash-alt"></i>
															</a>
														</div>
													</div>
								...
								<div class="product-feed-tab" id="my-bids">
									<ul class="nav nav-tabs bid-tab" id="myTab" role="tablist">
										<li class="nav-item"><a class="nav-link active"
											...
											aria-controls="home" aria-selected="true">Manage Bids</a></li>
										<li class="nav-item"><a class="nav-link" id="bidders-tab"
											data-toggle="tab" href="#bidders" role="tab"
											aria-controls="contact" aria-selected="false">Manage
												Bidders</a></li>
										<li class="nav-item"><a class="nav-link" id="profile-tab"
											data-toggle="tab" href="#profile" role="tab"
											aria-controls="profile" aria-selected="false">My Active
												Bids</a></li>
									</ul>
									<div class="tab-content" id="myTabContent">
											...
											<div class="post-bar">
												<div class="post_topbar">
													<div class="wordpressdevlp">
														...
														<p>
															<i class="la la-clock-o"></i>5 Hour Lefts
														</p>
													</div>
										...
										<div class="tab-pane fade" id="bidders" role="tabpanel"
											...
											<div class="post-bar">
												<div class="post_topbar post-bid">
													<div class="usy-dt">
														<img src="resources/images/resources/Jassica.jpg" alt="">
														<div class="usy-name">
															<h3>John Doe</h3>
															<div class="epi-sec epi2">
																<ul class="descp descptab bklink">
											...
											<div class="post-bar">
												<div class="post_topbar post-bid">
													<div class="usy-dt">
														<img src="resources/images/resources/rock.jpg" alt="">
														<div class="usy-name">
															<h3>John Doe</h3>
															<div class="epi-sec epi2">
																<ul class="descp descptab bklink">
								...
								<div class="product-feed-tab" id="info-dd">
									<div class="user-profile-ov">
										<h3>
											<a href="#" title="" class="overview-open">Overview</a> <a
												href="#" title="" class="overview-open"><i
										...
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											...
											viverra. Nunc eu augue nec arcu efficitur faucibus. Aliquam
											accumsan ac magna convallis bibendum. Quisque laoreet augue
											eget augue fermentum scelerisque. Vivamus dignissim mollis
											est dictum blandit. Nam porta auctor neque sed congue. Nullam
											rutrum eget ex at maximus. Lorem ipsum dolor sit amet,
											consectetur adipiscing elit. Donec eget vestibulum lorem.</p>
									</div>
									<!--user-profile-ov end-->
									<div class="user-profile-ov st2">
										<h3>
											<a href="#" title="" class="exp-bx-open">Experience </a><a
												href="#" title="" class="exp-bx-open"><i
												class="fa fa-pencil"></i></a> <a href="#" title=""
												class="exp-bx-open"><i class="fa fa-plus-square"></i></a>
										</h3>
										<h4>
											Web designer <a href="#" title=""><i class="fa fa-pencil"></i></a>
										</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit. Quisque tempor aliquam felis, nec condimentum ipsum
											commodo id. Vivamus sit amet augue nec urna efficitur
										...
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											...
											commodo id.</p>
										<h4>
											PHP developer <a href="#" title=""><i
												class="fa fa-pencil"></i></a>
										</h4>
										<p class="no-margin">Lorem ipsum dolor sit amet,
											consectetur adipiscing elit. Quisque tempor aliquam felis,
											nec condimentum ipsum commodo id. Vivamus sit amet augue nec
											urna efficitur tincidunt. Vivamus consectetur aliquam lectus
											commodo viverra.</p>
									</div>
									<!--user-profile-ov end-->
									<div class="user-profile-ov">
								...
								<div class="product-feed-tab" id="my-bids">
									<div class="posts-section">
										<div class="post-bar">
											...
											<div class="epi-sec">
												<ul class="descp">
													<li><img src="resources/images/icon8.png" alt=""><span>Frontend
															Developer</span></li>
													<li><img src="resources/images/icon9.png" alt=""><span>India</span></li>
												</ul>
												<ul class="bk-links">
											...
											<div class="job-status-bar">
												<ul class="like-com">
													<li><a href="#"><i class="la la-heart"></i> Like</a> <img
														src="resources/images/liked-img.png" alt=""> <span>25</span>
													</li>
													<li><a href="#" title="" class="com"><img
															src="resources/images/com.png" alt=""> Comment 15</a></li>
												</ul>
										...
										<div class="process-comm">
											<a href="#" title=""><img
												src="resources/images/process-icon.png" alt=""></a>
										</div>
										<!--process-comm end-->
									</div>
									<!--posts-section end-->
											...
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img1.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												</div>
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img2.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img3.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img4.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img5.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img6.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img7.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img8.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img9.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
												...
												<div class="col-lg-4 col-md-4 col-sm-6 col-6">
													<div class="gallery_pt">
														<img src="resources/images/resources/pf-img10.jpg" alt="">
														<a href="#" title=""><img
															src="resources/images/all-out.png" alt=""></a>
													</div>
													<!--gallery_pt end-->
								...
								<div class="product-feed-tab" id="payment-dd">
									<div class="billing-method">
										<ul>
											<li>
												<h3>Add Billing Method</h3> <a href="#" title=""><i
													class="fa fa-plus-circle"></i></a>
											</li>
											<li>
												<h3>See Activity</h3> <a href="#" title="">View All</a>
											</li>
											<li>
												<h3>Total Money</h3> <span>$0.00</span>
											</li>
										</ul>
										<div class="lt-sec">
											<img src="resources/images/lt-icon.png" alt="">
									...
									<div class="add-billing-method">
										...
										<h4>
											<img src="resources/images/dlr-icon.png" alt=""><span>With
												workwise payment protection , only pay for work delivered.</span>
										</h4>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="cc-head">
															<h5>Card Number</h5>
															<ul>
																<li><img src="resources/images/cc-icon1.png" alt=""></li>
																<li><img src="resources/images/cc-icon2.png" alt=""></li>
																<li><img src="resources/images/cc-icon3.png" alt=""></li>
																<li><img src="resources/images/cc-icon4.png" alt=""></li>
															</ul>
														</div>
													...
													<div class="col-lg-6">
														<div class="cc-head">
															<h5>
																Cvv (Security Code) <i class="fa fa-question-circle"></i>
															</h5>
														</div>
														<div class="inpt-field">
															<input type="text" name="l-name" placeholder="">
							...
							<div class="right-sidebar">
								...
								<div class="widget widget-portfolio">
									...
									<div class="pf-gallery">
										<ul>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery1.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery2.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery3.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery4.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery5.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery6.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery7.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery8.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery9.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery10.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery11.png" alt=""></a></li>
											<li><a href="#" title=""><img
													src="resources/images/resources/pf-gallery12.png" alt=""></a></li>
										</ul>
									</div>
									<!--pf-gallery end-->
								</div>
							...
							<div class="col-lg-6 no-left-pd">
								<div class="datefm">
									<input type="text" name="from" placeholder="From"
										class="datepicker"> <i class="fa fa-calendar"></i>
								</div>
							</div>
		...
		<div class="overview-box" id="create-portfolio">
			<div class="overview-edit">
				...
				<form>
					...
					<div class="pf-img">
						<img src="resources/images/resources/np.png" alt="">
					</div>

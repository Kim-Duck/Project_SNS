		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="resources/innerbody apply-jobbox">
						<h3>Attach File With CV</h3>
						<form>
							<input type="text" placeholder="Full Name"><br> <input
									...
									<div class="post-bar">
										...
										<div class="job_descp accountnone">
											...
											<p>
												...
												enim. s. ut suscipit urna sollicitudin at...<a href="#"
													title="">view more</a>
											</p>
											<ul class="skill-tags">
							...
							<div class="right-sidebar">
								<div class="widget widget-about bid-place">
									<button type="button" class="btn btn-primary"
										...
										data-whatever="@mdo">Apply a Job Now</button>
								</div>
								<!--widget-about end-->
								...
								<div class="widget widget-jobs">
									...
									<div class="sd-title copylink">
										<ul>
											<li><img src="resources/images/social3.png" alt="image">
											</li>
											...
											<li><img src="resources/images/social2.png" alt="image"></li>
										</ul>
									</div>
								</div>
								<!--widget-jobs end-->
